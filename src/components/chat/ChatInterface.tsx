      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className="max-w-3xl mx-auto space-y-6">
          {messages.length === 0 && (
            ...
            >
              <div className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${advisor.color} flex items-center justify-center text-4xl mb-6 shadow-glow`}>
                {advisor.icon}
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-8">
                {advisor.mentalModels.map((model) => (
                  <span key={model} className="px-3 py-1 rounded-full bg-secondary text-secondary-foreground text-sm">
                    {model}
                  </span>
                ))}
              </div>
              <p className="text-sm text-muted-foreground">
                Ask a question about a decision, problem, or goal you're working on.
              </p>
            </motion.div>
          )}
